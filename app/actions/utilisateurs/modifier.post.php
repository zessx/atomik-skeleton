...
if($this['db']->update('utilisateurs', $data, array('id_utilisateur' => $data['id_utilisateur']))) {
    ...
    $this->flash('L\'utilisateur a bien été modifié.&nbsp;&nbsp;<a href="'.Atomik::url('@ut_upd', array('id' => $id)).'" type="button" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-pencil"></span> Accès direct</a>', 'success');
} else {
